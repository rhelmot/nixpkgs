...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    ...
    x86_64-freebsd = {
      bash = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/aldkfyqiq0nspljgl5pr0pgvxq99qirk-x86_64-freebsd-bash";
        hash = "sha256-6keIiXGHkqtaNM1A+ysI3H4FUmbQcjY6RMq+ET9ImQE=";
      };
      mkdir = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/f00mn41pls87615px9qjzhxkrcyi2wxc-x86_64-freebsd-mkdir";
        hash = "sha256-rPNJ8R4EgyXsdsgxUKg05JbtoWrsd+3Txlhn2fiyan4=";
      };
      tar = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/0j1x2kvmb1j2fi9jsmlaxxpg22mj2l59-x86_64-freebsd-tar";
        hash = "sha256-qhc9sfH/IpB7XodEwF+sU7784gyBtZtvL+KUnzjboBA=";
      };
      unxz = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/y14fgwj3080h9bqdv5llsfywnq9gj2dx-x86_64-freebsd-unxz";
        hash = "sha256-it5W1qmVMa6fChgf6m6gWgJSoqxLA3pcx8dus3BDhSE=";
      };
      chmod = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/iab27r5x6jaklqg11s4rib7kb4fi1hkf-x86_64-freebsd-chmod";
        hash = "sha256-iBdzCXKU+03MfOA75ASrXOD3arPtQnvKqsdCf32oKxk=";
      };
      bootstrapFiles = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/wvbr4if59gqhc537ai7g98p4s0nxds85-x86_64-freebsd-bootstrap-files.tar.xz";
