...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    # These bootstrap hashes generated by compiling from nixpkgs 7970c0de66051ff456ab1d1f9fae2b6b3b84890b on x86_64-linux
    x86_64-freebsd = {
      bash = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/2lv3w2472nx7h8i01s9ll5fq107bamf6-x86_64-freebsd-bash";
        hash = "sha256-OZXb5XMJlkSwrTtkRVcT1cNnkwG+kk1cp3FOPeQAssA=";
      };
      mkdir = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/fnd8jlxddffx6yfhrdadkzpw0sjdjbvd-x86_64-freebsd-mkdir";
        hash = "sha256-LoIHdqGzSK+kcBZUaRpFEd0qw50ByRwm0Qn4Is1hit4=";
      };
      tar = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/42g2wm44lk2f3xp6sc3mdmdpi23q536k-x86_64-freebsd-tar";
        hash = "sha256-7AoLpBGE/1Y3Buk0xr0X6mbCJObOzFdhCIKqQB0U7jc=";
      };
      unxz = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/cf5mcn48nbf0qdsrr47jy675spvdmg2f-x86_64-freebsd-unxz";
        hash = "sha256-eu++t9XnaofdSTvfsIMFwnO46qrfR+6fsplj/6Wu6v4=";
      };
      chmod = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/adlbx6zkmrdcf3aj57bqy8gwa8m9hmz0-x86_64-freebsd-chmod";
        hash = "sha256-WAtiLwVzdhRh/l2OfXVFsYSjbQJk1FqOl0TfUaHhuU8=";
      };
      bootstrapFiles = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/mnd6iymkqnldkgi3g3njyffy62v1xhjn-x86_64-freebsd-bootstrap-files.tar.xz";
        hash = "sha256-6lwMBp7AfKLn5q5FsDqcjN+B0KJqPGjvQqDCWJCprF8=";
    ...
    aarch64-freebsd = {
      bash = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/i9ac1wrxlxamb16jpyjz9kn077qs5vk2-aarch64-freebsd-bash";
        hash = "sha256-AUtXayp+5zJ/mHs0fDGdavL5F4oPzR0mL1AeCB6cgoI=";
      };
      mkdir = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/8jz6jmjk8jp2qhw8q1n039602b7pkdyg-aarch64-freebsd-mkdir";
        hash = "sha256-tUAZIuZFzZvq022sx/y2EzQZ5NtHMkv+fr9C4NQrO78=";
      };
      tar = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/d2gdc7srvfyljg543s08l6cky3r2kdin-aarch64-freebsd-tar";
        hash = "sha256-NOX2bKa4aKxS95XCYBtUIRdinBSNSxzsZ0Y804Iei3I=";
      };
      unxz = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/wfrdn8jpb6dry1xszi6v4l4pajc4yfr6-aarch64-freebsd-unxz";
        hash = "sha256-pCbPtGyZLSs4XJNTLUApTv65Ecw0VuXk3FTY6n5twoo=";
      };
      chmod = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/wsxvnxj3mdzayp2sfgph31srszg3qaz8-aarch64-freebsd-chmod";
        hash = "sha256-0Un9K8HKJFC40OLUAvjRyC9lKiuwlBgn/W1/JW9ndSo=";
      };
      bootstrapFiles = {
        url = "https://nixbsd.mildlyfunctional.gay/dist/331jpn4b9ar10bk26xmm3iv32ll6ryvp-aarch64-freebsd-bootstrap-files.tar.xz";
        hash = "sha256-H5X1xKh2b+ikzsWp3J40eyPDh+IyllBbS9mHwbetv+Y=";
        name = "bootstrap-files.tar.xz";
        executable = false;
      };
    };
