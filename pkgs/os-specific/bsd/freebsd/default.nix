...
in lib.makeScope newScope (self: with self; { inherit stdenv;
  ...
  libavl = callPackage ./libavl.nix {};
  libicp = callPackage ./libicp.nix {};
  libnvpair = callPackage ./libnvpair.nix {};
  libtpool = callPackage ./libtpool.nix {};
  libzutil = callPackage ./libzutil.nix {};
  libzfs_core = callPackage ./libzfs_core.nix {};
  libuutil = callPackage ./libuutil.nix {};
  libzpool = callPackage ./libzpool.nix {};
  ...
  libumem = callPackage ./libumem.nix {};
