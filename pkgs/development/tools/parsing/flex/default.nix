...
stdenv.mkDerivation rec {
  ...
  ++ lib.optionals stdenv.hostPlatform.isFreeBSD [
    # TODO make unconditional next staging cycle. It will also be in a newer release.
    (fetchpatch {
      name = "fix-malloc-signature.patch";
      url = "https://github.com/westes/flex/commit/bf254c75b1e0d2641ebbd7fc85fb183f36a62ea7.patch";
      hash = "sha256-vTWRRgbQtlmdlNkPCkHqjcbUn1gDicoJdfnCaUz5aYc=";
    })
  ];
